...
public class HunterFragment extends Fragment implements RatingBar.OnRatingBarChangeListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        strengthRating = prefs.getFloat("hunterStrength", 0);
        sBar.setRating(strengthRating);
        intellectRating = prefs.getFloat("hunterIntellect", 0);
        iBar.setRating(intellectRating);
        wisdomRating = prefs.getFloat("hunterWisdom", 0);
        wBar.setRating(wisdomRating);
        dexterityRating = prefs.getFloat("hunterDexterity", 0);
                ...
                */
                case R.id.strengthRatingBar:
                            ...
                            (((totalPoints + strengthRating) - sBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("hunterStrength", sBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.intellectRatingBar2:
                            ...
                            (((totalPoints + intellectRating) - iBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("hunterIntellect", iBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.wisdomRatingBar3:
                            ...
                            (((totalPoints + wisdomRating) - wBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("hunterWisdom", wBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.dexterityRatingBar4:
                            ...
                            (((totalPoints + dexterityRating) - dBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("hunterDexterity", dBar.getRating());
                        editor.apply();
                    }
                    else
                    {
