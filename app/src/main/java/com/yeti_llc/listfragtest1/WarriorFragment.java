...
public class WarriorFragment extends Fragment implements RatingBar.OnRatingBarChangeListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        strengthRating = prefs.getFloat("warriorStrength", 0);
        sBar.setRating(strengthRating);
        intellectRating = prefs.getFloat("warriorIntellect", 0);
        iBar.setRating(intellectRating);
        wisdomRating = prefs.getFloat("warriorWisdom", 0);
        wBar.setRating(wisdomRating);
        dexterityRating = prefs.getFloat("warriorDexterity", 0);
                ...
                */
                case R.id.strengthRatingBar:
                            ...
                            (((totalPoints + strengthRating) - sBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("warriorStrength", sBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.intellectRatingBar2:
                            ...
                            (((totalPoints + intellectRating) - iBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("warriorIntellect", iBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.wisdomRatingBar3:
                            ...
                            (((totalPoints + wisdomRating) - wBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("warriorWisdom", wBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.dexterityRatingBar4:
                            ...
                            (((totalPoints + dexterityRating) - dBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("warriorDexterity", dBar.getRating());
                        editor.apply();
                    }
                    else
                    {
