...
public class HealerFragment extends Fragment implements RatingBar.OnRatingBarChangeListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        strengthRating = prefs.getFloat("healerStrength", 0);
        sBar.setRating(strengthRating);
        intellectRating = prefs.getFloat("healerIntellect", 0);
        iBar.setRating(intellectRating);
        wisdomRating = prefs.getFloat("healerWisdom", 0);
        wBar.setRating(wisdomRating);
        dexterityRating = prefs.getFloat("healerDexterity", 0);
                ...
                */
                case R.id.strengthRatingBar:
                            ...
                            (((totalPoints + strengthRating) - sBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("healerStrength", sBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.intellectRatingBar2:
                            ...
                            (((totalPoints + intellectRating) - iBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("healerIntellect", iBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.wisdomRatingBar3:
                            ...
                            (((totalPoints + wisdomRating) - wBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("healerWisdom", wBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.dexterityRatingBar4:
                            ...
                            (((totalPoints + dexterityRating) - dBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("healerDexterity", dBar.getRating());
                        editor.apply();
                    }
                    else
                    {
