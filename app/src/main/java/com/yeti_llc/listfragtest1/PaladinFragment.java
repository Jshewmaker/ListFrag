...
public class PaladinFragment extends Fragment implements RatingBar.OnRatingBarChangeListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        strengthRating = prefs.getFloat("paladinStrength", 0);
        sBar.setRating(strengthRating);
        intellectRating = prefs.getFloat("paladinIntellect", 0);
        iBar.setRating(intellectRating);
        wisdomRating = prefs.getFloat("paladinWisdom", 0);
        wBar.setRating(wisdomRating);
        dexterityRating = prefs.getFloat("paladinDexterity", 0);
                ...
                */
                case R.id.strengthRatingBar:
                            ...
                            (((totalPoints + strengthRating) - sBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("paladinStrength", sBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.intellectRatingBar2:
                            ...
                            (((totalPoints + intellectRating) - iBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("paladinIntellect", iBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.wisdomRatingBar3:
                            ...
                            (((totalPoints + wisdomRating) - wBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("paladinWisdom", wBar.getRating());
                        editor.apply();
                    }
                    else
                    {
                ...
                case R.id.dexterityRatingBar4:
                            ...
                            (((totalPoints + dexterityRating) - dBar.getRating()) >= 0))
                    {
                        ...
                        editor = prefs.edit();
                        editor.putFloat("paladinDexterity", dBar.getRating());
                        editor.apply();
                    }
                    else
                    {
